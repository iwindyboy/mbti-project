...
const menuItems: MenuItem[] = [
  ...
  },
  {
    ...
    icon: '✨',
    subItems: [
      { id: 'personal-saju', label: '🌙 선천적 성향 (사주)', path: '/fortune-report' },
      { id: 'personal-spectrum', label: '⚡ 후천적 성향 (32 Spectrum)', path: '/scan-result' },
      { id: 'personal-integrated', label: '📊 통합 리포트', path: '/integrated-result' },
      { id: 'personal-coaching', label: '💡 코칭', path: '/ai-coaching' },
    ],
  },
  {
    id: 'love-analysis',
    ...
    icon: '💕',
    subItems: [
      { id: 'love-saju', label: '🌙 선천적 연애 궁합 (사주)', path: '/coming-soon/love/saju-love' },
      { id: 'love-type', label: '💕 연애 유형 검사 (24유형)', path: '/dating/intro' },
      { id: 'love-post', label: '💑 후천적 연애 궁합 (29조합)', path: '/coming-soon/love/post-29' },
      { id: 'love-integrated', label: '📊 통합 연애 궁합 + 코칭', path: '/coming-soon/love/integrated-love' },
    ],
  },
