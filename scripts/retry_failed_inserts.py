...
failed_records = [
    ...
    {'cheongan': '甲', 'mbti_code': 'ISFJD', 'combo_type': '갭형'},
    {'cheongan': '乙', 'mbti_code': 'ISTJD', 'combo_type': '갭형'},
    {'cheongan': '丙', 'mbti_code': 'ISFPD', 'combo_type': '일치형'},
    {'cheongan': '丙', 'mbti_code': 'ESTPD', 'combo_type': '갭형'},
]
